                    ...
                    <div class="active-team-member section">
                        ...
                        <div class="team-member-item">
                            <div class="team-member box-shadow">
                                <div class="team-member-photo">
                                    <img src="assets/img/team/leader.jqg" alt="">
                                </div>
                                <div class="team-member-info pt-20">
                                    <h5 class="member-name"><a href="#!">Nguyễn Minh Long</a></h5>
                                    <p class="member-position">Member</p>
                                    <p class="mb-20">Quản trị hệ thống & Quản lý tài khoản</p>
                        ...
                        <div class="team-member-item">
                            <div class="team-member box-shadow">
                                ...
                                <div class="team-member-info pt-20">
                                    <h5 class="member-name"><a href="#!">Phan Công Được và Phạm Đình Văn</a></h5>
                                    <p class="member-position">Member</p>
                                    <p class="mb-20">Quản lý sản phẩm & danh mục</p>
                                    <p class="mb-20"> VÀ</p>
                                    <p class="mb-20"> Quản lý đơn hàng & khách hàng</p>
                                    <ul class="footer-social">
                                        <li>
                                            <a class="facebook" href="#!" title="Facebook"><i
                                                    class="zmdi zmdi-facebook"></i></a>
                        ...
                        <div class="team-member-item">
                            <div class="team-member box-shadow">
                                ...
                                <div class="team-member-info pt-20">
                                    <h5 class="member-name"><a href="#!">Hồ Hoàng Hiệp Và Nguyễn Đình Huy</a></h5>
                                    <p class="member-position">Member</p>
                                    <p class="mb-20">Trải nghiệm người dùng & thống kê/p>
                                    <p class="mb-20">VÀ/p>
                                    <p class="mb-20">Chăm sóc khách hàng & phản hồi/p>
                                    <ul class="footer-social">
                                        <li>
                                            <a class="facebook" href="#!" title="Facebook"><i
                                                    class="zmdi zmdi-facebook"></i></a>
                        ...
                        <div class="team-member-item">
                            <div class="team-member box-shadow">
                                ...
                                <div class="team-member-info pt-20">
                                    <h5 class="member-name"><a href="#">Lữ Thanh Lộc</a></h5>
                                    <p class="member-position">Member</p>
                                    <p class="mb-20">Quản lý nội dung</p>
                                    <ul class="footer-social">
                                        <li>
                                            <a class="facebook" href="#!" title="Facebook"><i
                                                    class="zmdi zmdi-facebook"></i></a>
